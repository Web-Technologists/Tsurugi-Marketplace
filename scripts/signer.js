...
class LazyMinter {
   ...
   * @returns {NFTVoucher}
   */
  async createVoucher(tokenId, quantity, minPrice, uri, creator, token, nonce) {
    const voucher = { tokenId, quantity, minPrice, uri, creator, token, nonce }
    ...
    console.log("HERE 1", domain, types, voucher)
